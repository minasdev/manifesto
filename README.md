...
**#5** O Minas Dev É para as comunidades, o que as comunidades são para seus membros, use e abuse do Minas Dev, mas não esqueça de alimentá-lo. Participe e divulgue para seus amigos e para suas comunidades o [Manifesto do Minas Dev](https://github.com/minasdev/manifesto/blob/master/README.md), o [Código de Conduta do Minas Dev](https://github.com/minasdev/codigo-de-conduta#código-de-conduta), o [Telegram do Minas Dev](https://t.me/minasdev), o [Site do Minas Dev](https://minasdev.org/), o [Twitter do Minas Dev](https://twitter.com/minasdev), o [LinkedIn do Minas Dev](https://linkedin.com/company/minasdev), o [Medium do Minas Dev](https://medium.com/minasdev), o [GitHub do Minas Dev](https://github.com/minasdev), etc. Espalhe a palavra como quiser, pois é evidente que sem ações conjuntas, qualquer benefício que o ideal almeje, morrerá com ele.

**#6** O Minas Dev NÃO foi idealizado para possuir UM dono, porém o Minas Dev possui líderes que mantêm a chama do ideal acesa e firme, e tais membros são destacados com naturalidade, uma vez que se manifestam constantemente, ATUALMENTE o Minas Dev é conduzido e liderado por [Beto Muniz](https://twitter.com/obetomuniz).
